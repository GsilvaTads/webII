...
export class Card {
     ...
     */
    // atividade 2: metodo atualizado para para validar a coluna recebida e alterar this._columnId
    /*
    ...
    */
    changeColumn(newColumnId) {
        const normalizedColumnId = Card.validateColumnId(newColumnId);
        this._columnId = normalizedColumnId;
    }
    rename(newTitle, newDescription) {
