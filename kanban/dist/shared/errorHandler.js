import { InvalidCardTitleError, InvalidCardColumnError, InvalidPriorityError, CardNotFoundError, WipLimitExceededError, DuplicateCardTitleError, } from '../cards/errors.js';
import { ColumnNotFoundError, InvalidColumnNameError, BoardNotFoundError, } from '../boards/errors.js';
import { NotImplementedError } from './errors.js';
export function errorHandler(err, _req, res, _next) {
    const errName = err?.name;
    if (err instanceof InvalidCardTitleError ||
    ...
    if (err instanceof WipLimitExceededError ||
